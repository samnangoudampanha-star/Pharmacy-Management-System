    ...
    <div>
        ...
        <div class="card">
            <div class="card-header bg-white d-flex">
                <h5 class="mb-0">{{ $t('menu.categories') }}</h5>
                <Link :href="route('admin.categories.index')" class="btn btn-outline-secondary btn-sm ms-auto">
            ...
            <form class="card-body" @submit.prevent="submit">
                ...
                <div class="mt-4 d-flex gap-2">
                    ...
                    <Link :href="route('admin.categories.index')" class="btn btn-outline-secondary">{{ $t('common.cancel') }}</Link>
                </div>
            </form>
        </div>
    </div>
...
function submit() {
    if (form.id) form.put(route('admin.categories.update', form.id));
