<template>
    <div>
        <Head :title="$t('menu.customers')" />
        <DataTable :title="$t('menu.customers')" :ajax-url="ajax_url" :columns="columns">
            <template #actions>
                <Link :href="route('admin.customers.create')" class="btn btn-primary">
